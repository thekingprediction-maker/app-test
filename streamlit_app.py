...
async function runAnalysis() {
    ...
    try {
        ...
        const subA = (cleanN(fCA["Falli Subiti"]) * 0.7) + (cleanN(fPA["Falli Subiti"]) * 0.3);
        const commA = (cleanN(fCA["Falli Commessi"]) * 0.7) + (cleanN(fPA["Falli Commessi"]) * 0.3);
        const subH = (cleanN(fCH["Falli Subiti"]) * 0.7) + (cleanN(fPH["Falli Subiti"]) * 0.3);
        ...
        resDiv.innerHTML = `
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="res-box border-l-yellow-500">
                    <p class="label-sm">Gialli (Dati API)</p>
                ...
                <div class="res-box border-l-emerald-500">
                    <p class="label-sm">Angoli (Dati API)</p>
