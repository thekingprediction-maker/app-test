...
st.set_page_config(page_title="PROBET AI V3 - MULTI LEAGUE SHOTS", layout="wide")
...
<body class="p-4 md:p-8">
    <div class="max-w-4xl mx-auto">
        <div class="text-center mb-10">
            ...
            <p class="text-[10px] font-bold text-slate-500 tracking-[0.5em] uppercase">Multi-League Shots Analysis • Manual Spread</p>
        </div>
